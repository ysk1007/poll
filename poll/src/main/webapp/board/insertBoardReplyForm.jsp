...
<div class="container mt-5">
    ...
    <div class="card shadow">
        ...
        <div class="card-header py-3">
            <h5 class="m-0 font-weight-bold text-primary">답글 입력</h5>
        </div>
        <div class="card-body">
            <form method="post" action="/poll/board/insertBoardReplyAction.jsp">
            	
            	<!-- ref, pos, depth 넘기기 -->
	            <input type="hidden" class="form-control" id="ref" name="ref" value="<%=ref%>" readonly>
	            <input type="hidden" class="form-control" id="pos" name="pos" value="<%=pos%>" readonly>
	            <input type="hidden" class="form-control" id="depth" name="depth" value="<%=depth%>" readonly>
